# Spelling Bee Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:spellingbee-api:1.1.14'
}
```
...
```java
import com.apiverve.spellingbee.SpellingBeeGeneratorAPIClient;
import com.apiverve.spellingbee.APIResponse;
import com.apiverve.spellingbee.APIException;

// Initialize the client
SpellingBeeGeneratorAPIClient client = new SpellingBeeGeneratorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/spellingbee](https://docs.apiverve.com/ref/spellingbee)
...
- **Documentation:** [https://docs.apiverve.com/ref/spellingbee](https://docs.apiverve.com/ref/spellingbee)
- **Issues:** [GitHub Issues](https://github.com/apiverve/spellingbee-api/issues)
