...
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/spellingbee";
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public SpellingBeeGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, SpellingBeeGeneratorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(SpellingBeeGeneratorQueryOptions options)
        {
        ...
        public ResponseObj Execute(SpellingBeeGeneratorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(SpellingBeeGeneratorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(SpellingBeeGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(SpellingBeeGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(SpellingBeeGeneratorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(SpellingBeeGeneratorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(SpellingBeeGeneratorQueryOptions options)
        {
