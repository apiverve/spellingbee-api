// Package spellingbee provides a Go client for the Spelling Bee Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/spellingbee?utm_source=go&utm_medium=readme
package spellingbee
...
// Request contains the parameters for the Spelling Bee Generator API.
//
// Parameters:
//   - difficulty: string - Difficulty: easy, medium, hard (affects word count)
type Request struct {
...
// ResponseData contains the data returned by the Spelling Bee Generator API.
type ResponseData struct {
	CenterLetter string `json:"centerLetter"`
	OuterLetters []string `json:"outerLetters"`
	AllLetters []string `json:"allLetters"`
	Difficulty string `json:"difficulty"`
	WordCount int `json:"wordCount"`
	PangramCount int `json:"pangramCount"`
