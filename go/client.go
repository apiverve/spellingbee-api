...
const (
	baseURL        = "https://api.apiverve.com/v1/spellingbee"
	defaultTimeout = 30 * time.Second
)

// Client is the Spelling Bee Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Spelling Bee Generator API client.
...
// Execute makes a request to the Spelling Bee Generator API with typed parameters.
//
